        ...
        updateWorkspace((current) => ({
          ...
          sourceStatus: {
            ...
            [selectedSource.contextKey]: {
              ...
              // Keep the canonical persisted validation fields in sync with the
              // immediate upload result so unresolved dengue locations remain
              // correct after status refreshes and login hydration.
